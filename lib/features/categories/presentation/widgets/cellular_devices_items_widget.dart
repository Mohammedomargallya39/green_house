...
class CellularDevicesItemsScreen extends StatelessWidget {
  const CellularDevicesItemsScreen({Key? key,}) : super(key: key);
        ...
        return  Column(
          ...
          children: [
            Padding(
              ...
              child: Text(
              appTranslation(context).cellularDevices,
            ...
            ConditionalBuilder(
              condition: AppCubit.get(context).cellularItemModel != null,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          AppCubit.get(context).cellularItemModel![index].name!,
                          maxLines: 1,
